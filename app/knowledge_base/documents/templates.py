...
TEMPLATES = {
    ...
    "разница между курсами/чем отличаются курсы/отличие курсов/в чем отличия этих курсов/ разница курсов/различия/ чем различаются": {
    ...
    "а мы входим в число первых 100/успеваем на акцию/еще есть скидка/Как проверить, входим ли мы в число первых 100 учеников": {
        "greeting": None,
