...
Если пользователь явно выражает желание записаться на пробный урок, начать запись, выбрать время или что-то подобное, 
твой ЕДИНСТВЕННЫЙ ответ должен быть специальной командой: [START_ENROLLMENT]. 
Не пиши ничего, кроме этой команды. Во всех остальных случаях веди диалог как обычно."""
